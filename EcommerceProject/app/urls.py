...
from .forms import LoginForm,CustomerPasswordChange,PasswordResetForm,PasswordResetConfirmForm
urlpatterns = [
    # path('', views.home),
    ...
    path('passwordchange/',auth_views.PasswordChangeView.as_view(template_name='app/passwordchange.html'
        ,form_class=CustomerPasswordChange,success_url='/passwordchangedone/'),name='passwordchange'),
